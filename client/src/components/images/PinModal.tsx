    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70" onClick={onClose}>
            ...
            >
                ...
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 z-10 p-2 bg-white/80 backdrop-blur-sm rounded-full hover:bg-white transition-all"
                >
                    <X className="w-6 h-6" />
                </button>
                    ...
                    <div className="md:w-1/2 flex flex-col h-full">
                        ...
                        <div className="p-6 border-b flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-semibold text-lg">{image.user?.username}</p>
                                        ...
                                        <form onSubmit={handleComment} className="flex gap-2 mb-4">
                                            ...
                                            <div className="flex-1 relative">
                                                <input
                                                    ...
                                                    className="w-full pl-4 pr-12 py-2 border border-gray-300 rounded-full focus:border-gray-500 focus:outline-none"
                                                />
                                                <button
                                                    type="submit"
